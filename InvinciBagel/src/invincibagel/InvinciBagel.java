...
public class InvinciBagel extends Application {
    ...
    private GamePlayPloop gamePlayPloop;
    Bagel iBagel;
    ...
    private void loadImageAssets() {
        ...
        iT1 = new Image("/treasure1.png", 64, 64, true, false, true);
    ...
    private void createGameActors() {
        iBagel = new Bagel(this, "M57,10 L46,25 30,26 30,41 18,41 18,44 27,56 37,57 35,75 39,81 43,81 45,53 54,40 63,43 72,26 Z",
...
//        castDirector.addCurrentCast(iPV1);
    ...
    private void createStartGameLoop() {
        gamePlayPloop = new GamePlayPloop(this);
        gamePlayPloop.start();
    }
